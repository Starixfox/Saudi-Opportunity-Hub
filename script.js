...
const opportunitiesData = [
{
  ...
  {
    id: "SA-003",
    title: "Custodian of the Two Holy Mosques Scholarship -
  Space Fields",
  ...
  {
    id: "SA-010",
    title: "Neo Space Group -
  EO Marketplace & Partnerships",
  ...
  {
    id: "SA-013",
    title: "CST Space Sector Regulations-
  ...
  {
    id: "SA-017",
    title: "PIF-backed Space Ventures -
  Direct Investment",
  ...
  Space Technology Track",
    ...
    funding_amount: "Typically USD 50K-
  500K per grant",
    funding_type: "grant",
  ...
  {
    id: "SA-021",
    title: "ISU Executive Space Course-
  Riyadh (ESC26)",
    description_short: "Four-day intensive executive program covering key dimensions of the space ecosystem, rescheduled to 12-
  15 April 2026 in Riyadh with Saudi Space Academy as Knowledge Partner.",
    type: "fellowship",
  ...
  },
  {
    ...
    description_short: "Non-dilutive grants of SAR 250K-
  2.5M covering 70-
  90% of project costs for Saudi AI startups; 90% coverage rate for female founders.",
    type: "grant",
    sponsor_institution: "Monsha'at",
    country: "Saudi Arabia",
    eligibility_region: "Saudi_only",
    eligibility_entities: "startups, SMEs",
    funding_amount: "SAR 250K-
  2.5M (70-
  90% cost coverage)",
    funding_type: "grant",
    application_link: "https://www.monshaat.gov.sa",
  ...
  },
  {
    ...
    description_short: "Seed-stage accelerator in Jeddah providing USD 10-
  20K investment for 10-
  20% equity, supporting early-stage tech startups.",
    type: "accelerator",
    sponsor_institution: "Flat6Labs",
    country: "Saudi Arabia",
    eligibility_region: "Saudi_only",
    eligibility_entities: "startups",
    funding_amount: "USD 10-
  20K for 10-
  20% equity",
    funding_type: "equity",
  ...
  {
    id: "SA-035",
    title: "Saudi Space Agency-
  Commercial Space License Window",
  ...
  {
    id: "SA-036",
    title: "Red Sea Global Innovation Challenge -
  Sustainability Tech",
  ...
  {
    id: "SA-037",
    title: "Aramco Entrepreneurship Center (Wa'ed)-
  Ventures",
  ...
  {
    id: "SA-038",
    title: "SABIC Ventures-
  Deeptech Co-investment",
  ...
  {
    id: "SA-039",
    title: "Misk Innovation -
  Space & DeepTech Cohort",
  ...
  {
    id: "SA-040",
    title: "KAFD Fintech & Innovation Hub -
  Space Finance Track",
  ...
  {
    id: "SA-041",
    title: "SSA Astronaut Program -
  Research Payload Opportunities",
  ...
  {
    id: "SA-042",
    title: "Monsha'at Export Development Program-
  Space Products",
  ...
  },
  {
    id: "SA-043",
    title: "PIF -
  ROSHN Smart Cities Technology Partners",
  ...
  },
  {
    id: "SA-044",
    title: "KAUST -
  CEMSE Space Systems Research Group",
  ...
  {
    id: "SA-046",
    title: "NEOM Tech & Digital Company -
  ...
  {
    id: "SA-047",
    title: "Supreme Space Council -
  National Space Strategy Grants",
  ...
  {
    id: "SA-050",
    title: "Vision 2030 Localization Contracts-
  Space Supply Chain",
  ...
  {
    id: "GCC-007",
    title: "Qatar Foundation Research Grants-
  Space Applications",
    ...
    eligibility_region: "GCC",
    eligibility_entities: "universities, researchers",
    funding_amount: "USD 100K-
  2M (varies by NPRP track)",
    funding_type: "grant",
  ...
  {
    id: "GCC-011",
    title: "UAE Planet X Challenge-
  Emirates Asteroid Mission",
  ...
  {
    id: "GCC-012",
    title: "Sirb SAR Satellite Program-
  ...
  {
    id: "GCC-016",
    title: "Hub71 Space Tech Program-
  Abu Dhabi",
  ...
  {
    id: "GCC-018",
    title: "In5 Tech Incubator-
  Dubai (Space & ICT)",
    description_short: "Dubai Internet City incubator offering 6-
  12 month programs for deeptech and ICT startups including satellite connectivity and EO data analytics companies.",
    type: "accelerator",
  ...
  {
    id: "GCC-020",
    title: "Oman Technology Fund-
  Space & ICT Investments",
  ...
  },
  {
    id: "GCC-021",
    title: "Bahrain EDB -
  Space Sector Investment Facilitation",
  ...
  {
    id: "GCC-022",
    title: "Kuwait KFAS Innovation Fund -
  Space R&D",
  ...
  },
  {
    ...
    eligibility_region: "Global_including_Saudi",
    eligibility_entities: "startups",
    funding_amount: "Seed investment (variable; typically USD 50K-
  250K) + program support",
    funding_type: "equity",
  ...
  Space Challenge",
    description_short: "EU's flagship innovation accelerator offering EUR 0.5M-
  12.5M in blended finance (grant + equity). Includes dedicated space and dual-use technology tracks.",
    type: "accelerator",
    sponsor_institution: "European Innovation Council (EIC)",
    country: "European Union",
    eligibility_region: "Global_including_Saudi",
    eligibility_entities: "startups, SMEs",
    funding_amount: "EUR 0.5M-
  2.5M grant + up to EUR 10M equity",
    funding_type: "mixed",
  ...
  },
  {
    ...
    deadline_date: "Annual cohort; applications typically open Jan-
  Apr",
    status: "closed_but_recurring",
    language: "English",
    notes: "",
  ...
  },
  {
    ...
    deadline_date: "Annual; typically Jan-
  Feb application deadline",
    status: "closed_but_recurring",
    language: "English",
    notes: "",
    last_verified: "2026-03-12",
